...
namespace Snakee
{
	...
	{
		int mapWidht; //поле, которое берет значение ширины
		int mapHeight; //поле, которое берет значение высоты
		char sym; //поле, которое содержит один символ и этим символом будет еда в игре
